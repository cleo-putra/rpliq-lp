...
const page = () => {
  return (
    <>
      ...
      {/* Section 3 web view */}
      <div className="xs:hidden md:block overflow-hidden bg-white lg:py-24 xs:py-10 max-container padding-container">
          ...
          <div className="lg:pr-8 lg:pt-12 xs:pt-0">
            <div className="lg:max-w-xl">
              ...
              <div className="mt-6 flex justify-normal gap-4">
                <Link href={"/contact-us"}>
                  <button className="flexCenter gap-3" type="button">
                    <label className="font-bold whitespace-nowrap btn_dark_green text-base">
                      Request a Free Demo
                    </label>
                  </button>
                </Link>
      ...
      <div className="md:hidden overflow-hidden bg-white lg:py-24 xs:py-10 max-container padding-container">
        <div className="mx-auto grid max-w-2xl xs:grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-12 xs:pt-0">
            <div className="lg:max-w-xl">
              <h2 className="lg:text-[30px] xs:text-xl font-bold text-black-50 mb-5">
                Is Your RTO’s RPL Journey Taking Too Long And Costing Too Much?
              </h2>
