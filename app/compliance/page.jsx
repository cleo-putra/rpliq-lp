  ...
  const page = () => {
    return (
      <>
        ...
        <ProductCard markText="Automated Compliance Checks" subHead=" Flag Any Potential Non-Compliance Issues" />
        <CarouselProduct />
        <ProductCard markText="Customisable Software" subHead="RPLIQ can be customised to align with Your specific needs" />
        <CardRto />
      </>
    );
  };
